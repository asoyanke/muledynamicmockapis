...
Dynamically create mock responses for APIs Retrieve mock payloads using request metadata Store and manage mock data using Object Store
...
- Input:HTTP Method: GETEndpoint: /resource
- Behaviour:Combine method + endpoint → keyFetch payload from Object StoreReturn stored response

## Mock POST API

Retrieve mock payload for POST requests.

- Input:HTTP Method: POSTEndpoint: /resource
- Behaviour:Combine method + endpoint → keyFetch payload from Object StoreReturn stored response

# **Object Store (OS) Operations**

## Stores a payload against a generated key.POST /api/osBody
